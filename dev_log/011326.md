...
Task B implementation: assembled asset catalog (CObject→Render→Mesh/Texture) and basic multi-mesh rendering.
...
- Restore/repair Ghidra MCP integration so reverse engineering work can be anchored to decompiled functions (Task C prerequisite)
